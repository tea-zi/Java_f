...
public class 문자열1_기본이론5_문자열함수 {
	/*
	 * # 문자열함수 [1] 문자의 길이 : length()
	 * 
	 * [2] 문자 한개 추출(인덱싱) : charAt(index)
	 * 
	 * [3] 문자 여러개 추출(슬라이싱) 1) substring(min , max-1) ==> 범위 2) substring(min) ==>
	 * 끝까지
	 * 
	 * [4] 구분자로 잘라내 배열에 담기 String str = "hello,java,android"; String[] ar =
	 * str.split(","); ar[0] = hello ar[1] = java ar[2] = android
	 */
